                ...
                <div className={styles.exchange}>
                    <div className={styles.header}>
                        <div className={styles.headerTop}>
                            <button className={styles.button} onClick={toggleChartWindow} aria-label="Toggle chart">
                                {isChartWindowOpen ?
                            ...
                            <>
                                <button className={styles.button} onClick={() => setSettingsOpen(true)} aria-label="Open settings">
