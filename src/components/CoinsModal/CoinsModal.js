...
export default function CoinsModal({ isOpen, onClose, selectedCoinId }) {
    ...
    function changeCoin(coin) {
        if (baseCoin.id === selectedCoinId) {
            setCoinData(prevState => ({...prevState, baseCoin: coin, baseAmount: '', targetAmount: ''}))
        } else {
            setCoinData(prevState => ({...prevState, targetCoin: coin, baseAmount: '', targetAmount: ''}))
        }
    }
